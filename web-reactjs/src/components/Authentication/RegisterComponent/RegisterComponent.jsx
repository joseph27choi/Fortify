...
import { Background1, BlackDiv, CentralDiv, ContentDiv, DescriptionDiv, InputWrapper, LoginDiv, LowerDiv, OptionsDiv, StyledBtn, StyledInput, StyledSelect, UpperDiv, BgImg, CenteredDiv } from './styles';
...
const registerBackgroundColor = backgroundColors.registerBackgroundColor;
                ...
                <CentralDiv>
                    <UpperDiv>
                        ...
                        <ContentDiv>
                            ...
                            <CenteredDiv>
                                <GoogleAuthComponent bgColor={registerBackgroundColor} />
                            </CenteredDiv>
                            <CenteredDiv>
                    ...
                    <LowerDiv>
                        ...
                        <BgImg className='bgimg' src={registerbg} />
                    </LowerDiv>
                </CentralDiv>
            </BlackDiv>
        </>
